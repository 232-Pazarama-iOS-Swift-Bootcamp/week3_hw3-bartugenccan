...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func setupWindow(with windowScene: UIWindowScene) {
        ...
        musicNavigationController.tabBarItem.image = UIImage(systemName: "headphones.circle")
        musicNavigationController.tabBarItem.selectedImage = UIImage(systemName: "headphones.circle.fill")
