...
final class DetailView: UIView {
    ...
    private var trackNameKeyLabel = UILabel()
    ...
    override init(frame: CGRect) {
        ...
        addToFavoritesButton.addTarget(self, action: #selector(addPodcastToFavorites), for: .touchUpInside)
    }
...
//MARK: - Methods
    @objc func addPodcastToFavorites() {

        let favPodcast = NSEntityDescription.insertNewObject(forEntityName: "FavProducts", into: context)
        

        favPodcast.setValue(trackNameLabel.text, forKey: "trackName")
